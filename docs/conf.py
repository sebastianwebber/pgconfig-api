...
latex_documents = [
  (master_doc, 'pgconfig-api.tex', u'PGConfig API Documentation',
   u'Sebastian Webber and contributors', 'manual'),
]
...
man_pages = [
    (master_doc, 'pgconfig-api', u'PGConfig API Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'PGConfig API', u'PGConfig API Documentation',
   author, 'PGConfig API', 'One line description of project.',
   'Miscellaneous'),
]
